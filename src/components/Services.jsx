  ...
  return (
    <>
      <div className="bg-baby-pink">
        <section className="bg-red-100 lg:w-[95%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex flex-col justify-center items-start gap-10 lg:px-20 px-6 py-20">
